...
const firstLine = document.querySelector('.header__burger-menu-first-line');
const secondLine = document.querySelector('.header__burger-menu-second-line');
...
document.addEventListener('click', (e) => {
    if (!e.target.closest('.js-menu')) {
      ...
      menuWrapper.classList.remove('active-wrapper');
    ...
    if (e.target.closest('.js-menu-items')) {
      ...
      menuWrapper.classList.add('active-wrapper');
...
burgerMenu.addEventListener('click', () => {
    ...
    menuWrapper.classList.toggle('active-wrapper');
  });
